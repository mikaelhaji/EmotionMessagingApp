...
/* harmony export */   "G": () => (/* binding */ eegmath)
/* harmony export */ });
...
var eegmath = /*#__PURE__*/function () {
  ...
  _createClass(eegmath, null, [{
    key: "genSineWave",
    value: //Collision diameter of air m
    //----------------------------------------------------------------
    //-------------------- Static Functions --------------------------
    //----------------------------------------------------------------
    ...
    value: function normalDistribution() {
      ...
      var variance = this.variance(samples);
      var nSamples = samples.length;
      var probabilities = [];
      var denom = 1 / (this.TWO_PI * variance);

      var _variance = 1 / variance;
    ...
    value: function interpolateArray(data, fitCount) {
      var normalize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
      var norm = normalize;
      ...
      if (arr.length > 1) {
        ...
        if (critical !== 'peak' && critical !== 'valley' && pass === false) {
          ...
          for (var _i = 0; _i < ref.length; _i++) {
            ...
            if (_i < Math.floor(ref.length * .5) && _val >= ref[Math.floor(ref.length * .5)]) {
              pass = false;
              break;
            } else if (_i > Math.floor(ref.length * .5) && _val >= ref[Math.floor(ref.length * .5)]) {
              pass = false;
              break;
            }
          }
      ...
      if (arr.length > 1) {
        ...
        if (critical !== 'peak' && critical !== 'valley' && pass === false) {
          ...
          for (var _i2 = 0; _i2 < ref.length; _i2++) {
            ...
            if (_i2 < ref.length * .5 && _val2 <= 0) {
              pass = false;
              break;
            } else if (_i2 > ref.length * .5 && _val2 > 0) {
              pass = false;
              break;
            }
          }
    ...
    key: "shift_deflate",
    value: function shift_deflate(M, eigenvalue, eigenvector) {
      ...
      var M_new = this.matsub(M, delta);
      return M_new;
    }
  }, {
    key: "eigenvalue_of_vector",
    value: function eigenvalue_of_vector(M, eigenvector) {
      // Xt * M * x
    ...
    key: "power_iteration",
    value: function power_iteration(M) {
      ...
      var rank = M.length; // Initialize the first guess pf the eigenvector to a row vector of the sqrt of the rank

      var eigenvector = new Array(rank).fill(0).map(function () {
        return new Array(1).fill(Math.sqrt(rank));
      }); // Compute the corresponding eigenvalue

      var eigenvalue = this.eigenvalue_of_vector(M, eigenvector);
      var epsilon = 1.0;
      var iter = 0;
      ...
      while (epsilon > tolerance && iter < max_iterations) {
        ...
        var Mv = this.matmul(M, eigenvector); // Normalize the eigenvector to unit length

        eigenvector = this.normalize(Mv); // Calculate the associated eigenvalue with the eigenvector (transpose(v) * M * v)

        eigenvalue = this.eigenvalue_of_vector(M, eigenvector); // Calculate the epsilon of the differences
    ...
    value: function eigens(M) {
      ...
      for (var i = 0; i < M.length; i++) {
        ...
        var result = this.power_iteration(M, tolerance, max_iterations); // Separate the eigenvalue and vector from the return array
...
eegmath.TWO_PI = Math.PI * 2;
eegmath.C = 299792458;
eegmath.G = 6.67430e-11;
eegmath.h = 6.62607015e-34;
eegmath.R = 8.31432e3;
eegmath.Ra = 287;
eegmath.H = 69.3;
eegmath.kbar = 1.054571817e-34;
eegmath.kB = 1.380649e-23;
eegmath.ke = 8.9875517923e9;
eegmath.me = 9.1093837015e-31;
eegmath.mp = 1.67262192369e-27;
eegmath.mn = 1.67492749804e-27;
eegmath.P0 = 1.01325e5;
eegmath.T0 = 288.15;
eegmath.p0 = 1.225;
eegmath.Na = 6.0220978e23;
eegmath.y = 1.405;
eegmath.M0 = 28.96643;
eegmath.g0 = 9.80665;
eegmath.Re = 6.3781e6;
eegmath.B = 1.458e-6;
eegmath.S = 110.4;
eegmath.Sigma = 3.65e-10;

eegmath.integral = function () {
...
eegmath.peakDetect = function (smoothedArray) {
  ...
  _createClass(gpuUtils, [{
    ...
    value: function callKernel() {
      ...
      var found = this.customFunctions.find(function (o) {
        if (o.name === name) {
          o.krnl.apply(o, _toConsumableArray(args));
          return true;
        }
      });
...
/* harmony export */ });
/* harmony import */ var _gpuUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(221);
/* harmony import */ var _eegmath__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(301);
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
function parseFunctionFromText(method) {
  ...
  var newFunc = eval(newFuncHead + newFuncBody + "}");
  return newFunc;
}
...
var CallbackManager = function CallbackManager() {
  ...
  try {
    window.gpu = new _gpuUtils_js__WEBPACK_IMPORTED_MODULE_0__/* .gpuUtils */ .T9();
    this.gpu = window.gpu;
  } catch (_unused) {
    var gpu = new _gpuUtils_js__WEBPACK_IMPORTED_MODULE_0__/* .gpuUtils */ .T9();
    this.gpu = gpu;
  }
  ...
  this.callbacks = [{
    ...
    callback: function callback(args) {
      ...
      var found = self.callbacks.findIndex(function (c) {
    ...
    callback: function callback(args) {
      ...
      _this.gpu.addFunction(parseFunctionFromText(args[0]));
    }
  }, {
    "case": 'addkernel',
    callback: function callback(args) {
      //arg0 = kernel name, arg1 = kernel function string
      _this.gpu.addKernel(args[0], parseFunctionFromText(args[1]));
    }
  }, {
    "case": 'callkernel',
    callback: function callback(args) {
      //arg0 = kernel name, args.slice(1) = kernel input arguments
      _this.gpu.callKernel(args[0], args.slice(1)); //generalized gpu kernel calls

    }
  }, {
    "case": 'xcor',
    callback: function callback(args) {
      return _eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath.crosscorrelation.apply */ .G.crosscorrelation.apply(_eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath */ .G, _toConsumableArray(args));
    }
  }, {
    "case": 'autocor',
    callback: function callback(args) {
      return _eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath.autocorrelation */ .G.autocorrelation(args);
    }
  }, {
    "case": 'cov1d',
    callback: function callback(args) {
      return _eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath.cov1d.apply */ .G.cov1d.apply(_eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath */ .G, _toConsumableArray(args));
    }
  }, {
    "case": 'cov2d',
    callback: function callback(args) {
      return _eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath.cov2d */ .G.cov2d(args);
    }
  }, {
    "case": 'sma',
    callback: function callback(args) {
      return _eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath.sma.apply */ .G.sma.apply(_eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath */ .G, _toConsumableArray(args));
    }
  }, {
    "case": 'dft',
    callback: function callback(args) {
    ...
    "case": 'coherence',
    callback: function callback(args) {
      var correlograms = _eegmath__WEBPACK_IMPORTED_MODULE_1__/* .eegmath.correlograms */ .G.correlograms(args[0]);
...
(() => {
"use strict";
/* harmony import */ var _workerCallbacks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(949);
...
self.onmessage = function (event) {
  ...
  manager.callbacks.find(function (o, i) {
