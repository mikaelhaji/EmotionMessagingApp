...
"use strict";var e=this&&this.__awaiter||function(e,t,i,r){return new(i||(i=Promise))(function(n,s){function a(e){try{u(r.next(e))}catch(t){s(t)}}function o(e){try{u(r.throw(e))}catch(t){s(t)}}function u(e){var t;e.done?n(e.value):(t=e.value,t instanceof i?t:new i(function(e){e(t)})).then(a,o)}u((r=r.apply(e,t||[])).next())})},t=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});const i=require("rxjs"),r=require("rxjs/operators"),n=t(require("firebase/app")),s=n.default.database.ServerValue.TIMESTAMP;function a(...e){return new n.default.User(...e)}exports.credentialWithLink=n.default.auth.EmailAuthProvider.credentialWithLink,exports.createUser=a;class o{constructor(e){this.app=e.app,this.app.auth().onAuthStateChanged(e=>{this.user=e})}auth(){return this.app.auth()}createAccount(t){return e(this,void 0,void 0,function*(){const{email:e,password:i}=t,[r,n]=yield this.app.auth().createUserWithEmailAndPassword(e,i).then(e=>[null,e]).catch(e=>[e,null]);return r?Promise.reject(r):n})}onAuthStateChanged(){return new i.Observable(e=>{this.app.auth().onAuthStateChanged(t=>{e.next(t)})})}onLogin(){return new i.Observable(e=>{const t=this.app.auth().onAuthStateChanged(t=>{t&&(e.next(t),e.complete())});return()=>t()})}login(e){if("customToken"in e){const{customToken:t}=e;return this.app.auth().signInWithCustomToken(t)}if("idToken"in e&&"providerId"in e){const t=new n.default.auth.OAuthProvider(e.providerId).credential(e.idToken);return this.app.auth().signInWithCredential(t)}if("email"in e&&"password"in e){const{email:t,password:i}=e;return this.app.auth().signInWithEmailAndPassword(t,i)}throw new Error("Either {email,password}, {customToken}, or {idToken,providerId} is required")}logout(){return this.app.auth().signOut()}createCustomToken(){return e(this,void 0,void 0,function*(){const[e,t]=yield this.app.functions().httpsCallable("createCustomToken")().then(({data:e})=>[null,e]).catch(e=>[e,null]);return e?Promise.reject(e):t})}getDevices(){var t;return e(this,void 0,void 0,function*(){if(!(null===(t=this.user)||void 0===t?void 0:t.uid))return Promise.reject("Please login.");const e=(yield this.app.database().ref(this.getUserDevicesPath()).once("value")).val();return this.userDevicesToDeviceInfoList(e)})}addDevice(t){var i;return e(this,void 0,void 0,function*(){const e=null===(i=this.user)||void 0===i?void 0:i.uid;if(!e)return Promise.reject("Please login.");const[r,n]=yield this.isDeviceIdValid(t).then(e=>[e]).catch(e=>[!1,e]);if(!r)return Promise.reject(n);const a=this.getDeviceClaimedByPath(t),o=this.getUserClaimedDevicePath(t),[u,c]=yield this.app.database().ref().update({[a]:e,[o]:{claimedOn:s}}).then(()=>[!1]).catch(e=>[!0,e]);return u?Promise.reject(c):void 0})}removeDevice(t){var i;return e(this,void 0,void 0,function*(){if(!(null===(i=this.user)||void 0===i?void 0:i.uid))return Promise.reject("Please login.");const e=this.getDeviceClaimedByPath(t),r=this.getUserClaimedDevicePath(t),n=this.app.database().ref(e),s=this.app.database().ref(r),[a,o]=yield Promise.all([n.remove(),s.remove()]).then(()=>[!1]).catch(e=>[!0,e]);return a?Promise.reject(o):void 0})}isDeviceIdValid(t){return e(this,void 0,void 0,function*(){if(!t||32!==t.length||!/[0-9A-Fa-f]{32}/g.test(t))return Promise.reject("The device id is incorrectly formatted.");const e=this.getDeviceClaimedByPath(t),i=this.app.database().ref(e),r=yield i.once("value").catch(()=>null);return!(!r||r.exists())||Promise.reject("The device has already been claimed.")})}onUserDevicesChange(){return this.onAuthStateChanged().pipe(r.switchMap(e=>{if(!e)return i.empty();const t=this.getUserDevicesPath(),n=this.app.database().ref(t);return i.fromEventPattern(e=>n.on("value",e),e=>n.off("value",e)).pipe(r.map(e=>e.val()),r.switchMap(e=>i.from(this.userDevicesToDeviceInfoList(e))))}))}userDevicesToDeviceInfoList(t){return e(this,void 0,void 0,function*(){const e=Object.keys(null!=t?t:{}).map(e=>this.app.database().ref(this.getDeviceInfoPath(e)).once("value")),i=(yield Promise.all(e).then(e=>e.map(e=>e.val()))).filter(e=>!!e);return i.sort((e,i)=>t[e.deviceId].claimedOn-t[i.deviceId].claimedOn),i})}hasDevicePermission(t){return e(this,void 0,void 0,function*(){const e=this.getDeviceInfoPath(t);return yield this.app.database().ref(e).once("value").then(()=>!0).catch(()=>!1)})}getDeviceClaimedByPath(e){return`devices/${e}/status/claimedBy`}getUserClaimedDevicePath(e){return`users/${this.user.uid}/devices/${e}`}getUserDevicesPath(){return`users/${this.user.uid}/devices`}getDeviceInfoPath(e){return`devices/${e}/info`}}exports.FirebaseUser=o;
...
"use strict";var e=this&&this.__awaiter||function(e,t,i,r){return new(i||(i=Promise))(function(s,n){function c(e){try{o(r.next(e))}catch(t){n(t)}}function a(e){try{o(r.throw(e))}catch(t){n(t)}}function o(e){var t;e.done?s(e.value):(t=e.value,t instanceof i?t:new i(function(e){e(t)})).then(c,a)}o((r=r.apply(e,t||[])).next())})},t=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var i in e)Object.hasOwnProperty.call(e,i)&&(t[i]=e[i]);return t.default=e,t};Object.defineProperty(exports,"__esModule",{value:!0});const i=require("rxjs"),r=require("rxjs/operators"),s=require("./api/index"),n=require("./utils/whileOnline"),c=require("./utils/subscription"),a=t(require("./utils/errors")),o={timesync:!1,autoSelectDevice:!0};class l{constructor(e={}){this._localModeSubject=new i.BehaviorSubject(!1),this.getMetric=(e=>{const{metric:t,labels:s,atomic:a}=e,o=c.validate(t,s,this.options);if(o)return i.throwError(o);const l=e=>new i.Observable(i=>{const r=(a?[this.api.metrics.subscribe({metric:t,labels:s,atomic:a,serverType:e})]:s.map(i=>this.api.metrics.subscribe({metric:t,labels:[i],atomic:a,serverType:e}))).map(e=>({subscription:e,listener:this.api.metrics.on(e,(...e)=>{i.next(...e)})}));return()=>{r.forEach(({subscription:e,listener:t})=>{this.api.metrics.unsubscribe(e,t)})}});return this.onDeviceChange().pipe(r.switchMap(e=>{if(!e)return i.empty();const{deviceId:s}=e;return this.isLocalMode().pipe(r.switchMap(e=>e&&c.isNotionMetric(t)?this.socketUrl().pipe(r.switchMap(e=>this.api.setWebsocket(e,s)),r.switchMap(()=>l(this.api.localServerType))):(this.api.unsetWebsocket(),l(this.api.defaultServerType))))}),n.whileOnline({status$:this.status(),allowWhileOnSleepMode:!1}))}),this.options=Object.freeze(Object.assign(Object.assign({},o),e)),this.api=new s.ApiClient(this.options)}login(t){return e(this,void 0,void 0,function*(){return yield this.api.login(t)})}logout(){return e(this,void 0,void 0,function*(){return yield this.api.logout()})}__getApp(){return this.api.__getApp()}onAuthStateChanged(){return this.api.onAuthStateChanged()}addDevice(e){return this.api.addDevice(e)}removeDevice(e){return this.api.removeDevice(e)}onUserDevicesChange(){return this.api.onUserDevicesChange()}getDevices(){return e(this,void 0,void 0,function*(){return yield this.api.getDevices()})}selectDevice(t){return e(this,void 0,void 0,function*(){return yield this.api.selectDevice(t)})}getSelectedDevice(){return e(this,void 0,void 0,function*(){return yield this.api.getSelectedDevice()})}getInfo(){return e(this,void 0,void 0,function*(){return this.api.didSelectDevice()?yield this.api.getInfo():Promise.reject(a.mustSelectDevice)})}isLocalMode(){return this._localModeSubject.asObservable().pipe(r.share())}onDeviceChange(){return this.api.onDeviceChange()}enableLocalMode(t){return e(this,void 0,void 0,function*(){if("boolean"!=typeof t)return Promise.reject(new TypeError("enableLocalMode can only accept a boolean"));if(!t)return this._localModeSubject.next(t),t;const[e,i]=yield this.api.onceNamespace("context/socketUrl").then(e=>{if(!e){return[!1,new Error("Your device's OS does not support localMode. Try updating to the latest OS.")]}return[!0,null]}).catch(e=>[!1,e]);return e?(this._localModeSubject.next(t),t):Promise.reject(i)})}disconnect(){return e(this,void 0,void 0,function*(){return yield this.api.disconnect()})}socketUrl(){const{onDeviceSocketUrl:e}=this.options;return e?i.of(e):this.api.observeNamespace("context/socketUrl")}dispatchAction(e){return this.api.didSelectDevice()?this.api.actions.dispatch(e):Promise.reject(a.mustSelectDevice)}addMarker(e){if(!this.api.didSelectDevice())throw a.mustSelectDevice;if(!e)throw new Error("Notion: a label is required for addMarker");this.dispatchAction({command:"marker",action:"add",message:{label:e,timestamp:this.api.timestamp}})}accelerometer(){const e="accelerometer";return i.from(this.getSelectedDevice()).pipe(r.switchMap(t=>{return Number(null==t?void 0:t.modelVersion)>=2?this.getMetric({metric:e,labels:c.getLabels(e),atomic:!0}):i.throwError(new Error(`The ${e} metric is not supported by this device. Model version 2 or greater required.`))}))}awareness(e,...t){return this.getMetric({metric:"awareness",labels:e?[e,...t]:[],atomic:!1})}brainwaves(e,...t){return this.getMetric({metric:"brainwaves",labels:e?[e,...t]:[],atomic:!1})}calm(){return this.awareness("calm")}signalQuality(){return this.getMetric({metric:"signalQuality",labels:c.getLabels("signalQuality"),atomic:!0})}emotion(e,...t){return this.getMetric({metric:"emotion",labels:e?[e,...t]:[],atomic:!1})}settings(){return this.api.observeNamespace("settings")}focus(){return this.awareness("focus")}kinesis(e,...t){return this.getMetric({metric:"kinesis",labels:e?[e,...t]:[],atomic:!1})}predictions(e,...t){return this.getMetric({metric:"predictions",labels:e?[e,...t]:[],atomic:!1})}status(){return this.api.status()}changeSettings(e){return this.api.didSelectDevice()?this.api.changeSettings(e):Promise.reject(a.mustSelectDevice)}get training(){return{record:e=>{if(!this.api.didSelectDevice())throw a.mustSelectDevice;const t=this.api.user&&"uid"in this.api.user?this.api.user.uid:null,i=Object.assign(Object.assign({fit:!1,baseline:!1,timestamp:this.api.timestamp},e),{userId:t});this.api.actions.dispatch({command:"training",action:"record",message:i})},stop:e=>{if(!this.api.didSelectDevice())throw a.mustSelectDevice;this.api.actions.dispatch({command:"training",action:"stop",message:Object.assign({},e)})},stopAll:()=>{if(!this.api.didSelectDevice())throw a.mustSelectDevice;this.api.actions.dispatch({command:"training",action:"stopAll",message:{}})}}}goOffline(){this.api.goOffline()}goOnline(){this.api.goOnline()}createAccount(e){return this.api.createAccount(e)}createCustomToken(){return this.api.createCustomToken()}skill(t){return e(this,void 0,void 0,function*(){if(!this.api.didSelectDevice())return Promise.reject(a.mustSelectDevice);const e=yield this.api.skills.get(t);return null===e?Promise.reject(new Error(`Access denied for: ${t}. Make sure the skill is installed.`)):{metric:t=>{const s=`skill~${e.id}~${t}`,n=new i.Observable(e=>{const i=this.api.metrics.subscribe({metric:s,labels:[t],atomic:!0}),r=this.api.metrics.on(i,(...t)=>{e.next(...t)});return()=>{this.api.metrics.unsubscribe(i,r)}}).pipe(r.map(e=>e[t]));return Object.defineProperty(n,"next",{value:e=>{this.api.metrics.next(s,{[t]:e})}}),n}}})}}exports.Notion=l,l.credentialWithLink=s.credentialWithLink,l.createUser=s.createUser,l.SERVER_TIMESTAMP=s.SERVER_TIMESTAMP;
